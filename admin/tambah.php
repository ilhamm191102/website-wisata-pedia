    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <ul>
            ...
            <li>
                ...
                <input type="text" name="tempat" id="tempat" placeholder="Masukkan tempat">
            </li>
            <li>
            ...
            <li>
                ...
                <input type="text" name="deskripsi_info" id="deskripsi_info" placeholder="Masukkan deskripsi info">
            </li>
            <li>
                <label for="jenis">jenis:</label>
                <input type="text" name="jenis" id="jenis" placeholder="Masukkan jenis destinasi">
            </li>
            <li>
